...
export default function AuthPortal({ initialMode, initialRole }: AuthPortalProps) {
  ...
  const [mode, setMode] = useState<"LOGIN" | "REGISTER">(initialMode || queryMode);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-gradient-to-b from-slate-950 via-resq-navy to-[#07192d] text-white">
      <div className="w-full max-w-4xl space-y-6 my-8">
        {/* Brand Header */}
        <div className="text-center space-y-2">
          <Link href="/" className="inline-flex items-center gap-2 group">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-resq-blue to-resq-green flex items-center justify-center text-white font-black text-lg shadow-glow">
              RQ
            </div>
            <span className="text-3xl font-black tracking-tight text-white group-hover:text-resq-green-bright transition-colors">
              RESQFOOD
            </span>
          </Link>
          <p className="text-xs sm:text-sm text-slate-300 font-medium">
            Stakeholder Registration & Operational Gateway
          </p>
        </div>
        ...
        {/* Main Card Container */}
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-white/20 shadow-2xl text-slate-900">
